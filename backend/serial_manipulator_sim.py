...
from robot_kinematics import solve_forward_kinematics, solve_inverse_kinematics
...
class SerialManipulator:
    ...
    def get_joint_positions(self):
        ...
        '''
        self.joint_positions = solve_forward_kinematics(
...
class ThreeLinkManipulator(SerialManipulator):
    ...
    def move_to(self, target: np.ndarray, num_points: int = 21, wait_time: int = 250, allow_negative_y: bool = False):
        ...
        for i, point in enumerate(points):
            best_angles = self.get_joint_angles(point)
    ...
    def get_joint_angles(self, target: np.ndarray):
        ...
        def cost(x: float):
            ...
            joint_positions_sol1 = solve_forward_kinematics(
                self.lengths, sol1_3lm)
            joint_positions_sol2 = solve_forward_kinematics(
